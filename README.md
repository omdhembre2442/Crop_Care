...
- [Fertilizer suggestion dataset](https://github.com/Gladiator07/Crop Care/blob/master/Data-processed/fertilizer.csv) (custom built dataset)
...
#### Deployment is done using [deploy](https://github.com/Gladiator07/Crop Care/tree/deploy) branch
#### This website is deployed at [Heroku](https://www.heroku.com/)
#### You can access it [here](https://Crop Care.herokuapp.com/)
...
- Clone the complete project with `git clone https://github.com/Gladiator07/Crop Care.git` or you can just download the code and unzip it
- **Note:** The master branch doesn't have the updated code used for deployment, to download the updated code used for deployment you can use the following command
  ```
  ❯ git clone -b deploy https://github.com/Gladiator07/Crop Care.git 
  ```
- `deploy` branch has only the code required for deploying the app (rest of the code that was used for training the models, data preparation can be accessed on `master` branch)
- It is highly recommended to clone the deploy branch for running the project locally (the further steps apply only if you have the deploy branch cloned)
- Once the project is cloned, open anaconda prompt in the directory where the project was cloned and paste the following block
  ```
  conda create -n Crop Care python=3.6.12
...
## Contribute 👨‍💻
Please read [CONTRIBUTING.md](https://github.com/Gladiator07/Crop Care/blob/master/CONTRIBUTING.md) for details on our code of conduct, and the process for submitting pull requests to us.
...
## License 📝
This project is licensed under [GNU (GENERAL PUBLIC LICENSE)](https://github.com/Gladiator07/Crop Care/blob/master/LICENSE).
